...
include_once 'student_delete.php';
...
<head>
    ...
    <script>
        function confirmDesactive() {
            if (confirm("are you sure . ? delete your data"))
                return true;
            return false;
        }
    </script>
...
<body>
    ...
    <div class="container mt-3">
        <form method="POST" action="student_delete.php" onsubmit="return confirmDesactive()">
